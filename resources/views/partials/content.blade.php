            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    ...
                    <div class="row align-items-start">
                        <div class="col-md-7">
                            <p class="text-secondary fs-13px mb-3 mb-md-0">Revenue is income that a business has from its
                                normal business activities, usually from sale of goods and services to customers.</p>
                        </div>
        ...
        <div class="col-lg-7 col-xl-8 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-secondary">Sales are activities related to selling or number of goods or services
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-column">
                        <a href="javascript:;" class="d-flex align-items-center border-bottom pb-3">
                            <div class="me-3">
                                <img src="{{ asset('Backend/assets/images/faces/face2.jpg') }}" class="rounded-circle w-35px" alt="user">
                            </div>
                            <div class="w-100">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                            <div class="me-3">
                                <img src="{{ asset('Backend/assets/images/faces/face3.jpg') }}" class="rounded-circle w-35px" alt="user">
                            </div>
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                            <div class="me-3">
                                <img src="{{ asset('Backend/assets/images/faces/face4.jpg') }}" class="rounded-circle w-35px" alt="user">
                            </div>
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                            <div class="me-3">
                                <img src="{{ asset('Backend/assets/images/faces/face5.jpg') }}" class="rounded-circle w-35px" alt="user">
                            </div>
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
                        ...
                        <a href="javascript:;" class="d-flex align-items-center border-bottom py-3">
                            <div class="me-3">
                                <img src="{{ asset('Backend/assets/images/faces/face6.jpg') }}" class="rounded-circle w-35px" alt="user">
                            </div>
                            <div class="w-100">
                                <div class="d-flex justify-content-between">
